...
/**
 * Esta clase representa la vista del CRUD de los artículos.
 * 
 * @author Denis Peña
 * @version 1.0
 * @since 2025-02-12
...
public class CrudArticulos extends JFrame {
	...
	public CrudArticulos() {
		...
		pnlFormulario.setBorder(new TitledBorder(
		...
		panel.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "CONSULTA",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 64, 128)));
		...
		scrollPane.setBounds(26, 37, 339, 132); 
	...
	/**
	 * Método que ajusta el ancho de las columnas de la tabla que muestra la
	 * consulta de los artículos registrados.
	 * 
	...
	public void ajustarAnchoColumnas(JTable tabla) {
		...
		for (int col = 0; col < tabla.getColumnCount(); col++) {
			...
			Component headerComp = headerRenderer.getTableCellRendererComponent(tabla, tabla.getColumnName(col), false,
					false, 0, col);
	...
	/**
	 * Método que centra el contenido de las celdas de la tabla.
	 * 
	...
	/**
	 * Método que borra el contenido de los campos de texto del CRUD de artículos.
	 */
	public void limpiar() {
